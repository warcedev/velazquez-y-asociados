  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#F8FAFC] via-white to-[#0A2540]/5 dark:from-[#0F172A] dark:via-[#0A2540]/30 dark:to-[#D4AF37]/5" />
        
        {/* Elementos decorativos de fondo */}
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-[#D4AF37]/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#0A2540]/10 rounded-full blur-3xl" />
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <motion.h1
              ...
              className="font-serif text-5xl md:text-7xl lg:text-8xl font-bold text-[#0A2540] dark:text-white mb-6 leading-tight"
            >
              Velázquez
            ...
            >
              <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Somos una firma jurídica enfocada en brindar soluciones legales 
            ...
            >
              ...
              <button
                ...
                className="px-8 py-4 border-2 border-[#0A2540] dark:border-white text-[#0A2540] dark:text-white font-semibold rounded-full hover:bg-[#0A2540]/5 transition-all duration-300 hover:-translate-y-1"
              >
                Conocer al Equipo
              </button>
            </motion.div>
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-white to-[#F8FAFC] dark:from-[#0F172A] dark:to-[#0A2540]/20">
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Botón para ir a "Nosotros" - AGREGADO */}
            <motion.div
              initial={{ y: 20, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              viewport={{ once: true }}
